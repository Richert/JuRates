%module auto_getfield(Main, Symbol("##392")){getfield(Main, Symbol("##125#129")),getfield(Main, Symbol("##126#130")),getfield(Main, Symbol("##127#131")),Nothing,Nothing,getfield(Main, Symbol("##128#132")),Expr,Expr}_vf
