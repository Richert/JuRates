%module auto_getfield(Main, Symbol("##396")){getfield(Main, Symbol("##141#145")),getfield(Main, Symbol("##142#146")),getfield(Main, Symbol("##143#147")),Nothing,Nothing,getfield(Main, Symbol("##144#148")),Expr,Expr}_vf
