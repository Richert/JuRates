%module auto_getfield(Main, Symbol("##390")){getfield(Main, Symbol("##117#121")),getfield(Main, Symbol("##118#122")),getfield(Main, Symbol("##119#123")),Nothing,Nothing,getfield(Main, Symbol("##120#124")),Expr,Expr}_vf
