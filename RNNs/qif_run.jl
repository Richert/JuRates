using DifferentialEquations,Plots, InvertedIndices
...
solution = solve(model, Tsit5(), save_idxs=target_vars, callback=cb_spike, force_dtmin=true, dense=false, dtmin=1e-8, reltol=1e-6, abstol=1e-7)
